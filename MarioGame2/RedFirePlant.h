...
#define RED_FIRE_PLANT_SWITCH_ANI_X 8
#define RED_FIRE_PLANT_SWITCH_ANI_Y 8

#define RED_FIRE_PLANT_FIREBALL_OFFSET_X 0
#define RED_FIRE_PLANT_FIREBALL_OFFSET_Y -38
