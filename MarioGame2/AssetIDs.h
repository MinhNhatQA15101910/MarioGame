...
#define ID_SPRITE_CLOUD_BEGIN_TOP (ID_SPRITE_CLOUD + 1000)
#define ID_SPRITE_CLOUD_MIDDLE_TOP (ID_SPRITE_CLOUD + 2000)
#define ID_SPRITE_CLOUD_END_TOP (ID_SPRITE_CLOUD + 3000)
#define ID_SPRITE_CLOUD_BEGIN_BOTTOM (ID_SPRITE_CLOUD + 4000)
#define ID_SPRITE_CLOUD_MIDDLE_BOTTOM (ID_SPRITE_CLOUD + 5000)
#define ID_SPRITE_CLOUD_END_BOTTOM (ID_SPRITE_CLOUD + 6000)

#define ID_SPRITE_BLACK_TILE 60000
#define ID_SPRITE_BLACK_TILE_TOP_LEFT (ID_SPRITE_BLACK_TILE + 1000)
#define ID_SPRITE_BLACK_TILE_TOP_MIDDLE (ID_SPRITE_BLACK_TILE + 2000)
#define ID_SPRITE_BLACK_TILE_TOP_RIGHT (ID_SPRITE_BLACK_TILE + 3000)
#define ID_SPRITE_BLACK_TILE_MIDDLE_LEFT (ID_SPRITE_BLACK_TILE + 4000)
#define ID_SPRITE_BLACK_TILE_MIDDLE_RIGHT (ID_SPRITE_BLACK_TILE + 6000)
#define ID_SPRITE_BLACK_TILE_BOTTOM_LEFT (ID_SPRITE_BLACK_TILE + 7000)
#define ID_SPRITE_BLACK_TILE_BOTTOM_MIDDLE (ID_SPRITE_BLACK_TILE + 8000)
#define ID_SPRITE_BLACK_TILE_BOTTOM_RIGHT (ID_SPRITE_BLACK_TILE + 9000)
